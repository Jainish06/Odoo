...
class PreviousYearMarks(models.Model):
    ...
    subject = fields.Many2one('subject.subject', 'Subject', reuired=True)
    ...
    total_obtained_marks = fields.Float(compute='_compute_total_marks', string='Total obtained marks.', store=True)
